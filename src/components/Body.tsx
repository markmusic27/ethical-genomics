...
export const Body = () => {
  return (
    <div className="relative mx-auto w-[600px]">
      ...
      <div className="h-[48px]" />
      <Content
        header="Notes on Images from Gameplay"
        body="All of the images that were displayed on the game were generated by ChatGPT 4o. I prompted it with a concept image based on the decision using a Studio Ghibli art style. I then imported this into my code where it's used."
        data-section="reflection"
      />
